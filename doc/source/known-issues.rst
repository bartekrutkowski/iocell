...
This issue does not affect iocell jails from functioning properly, but can present challenges
...
iocell does not validate properties right now. Please refer to man page to see what is supported
for each property. By default iocell pre-configures each property with a safe default.
...
As a workaround iocell allows a warm restart without destroying the jail.
...
There are production machines with iocell and VNET jails running well beyond 100 days of uptime
...
You can read a little more about this `here <https://github.com/iocell/iocell/issues/119>`_ and at the mailing list post `here <https://lists.freebsd.org/pipermail/freebsd-jail/2013-July/002347.html>`_.
